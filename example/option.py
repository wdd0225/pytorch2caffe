...
parser.add_argument('--nThread', type=int, default=1, help='number of threads for data loading')
parser.add_argument('--cpu', default='True', help='use cpu only')
parser.add_argument('--nGPU', type=int, default=1, help='number of GPUs')

# parser.add_argument("--datadir", type=str, default="dataset_4", help='dataset directory')
# parser.add_argument("--datadir", type=str, default="market_cuhk03_duke", help='dataset directory')
parser.add_argument("--datadir", type=str, default="/home/wdd/Work/Pytorch/MGN-pytorch-master/Market-1501-v15.09.15", help='dataset directory')
...
# parser.add_argument('--pool', type=str, default='avg', help='pool function') #ori
...
parser.add_argument('--dampening', type=float, default=0.0005, help='SGD dampening')
...
parser.add_argument("--outdir", type=str, default='out', help='')  # not used 
parser.add_argument("--resume", type=int, default=100, help='resume from specific checkpoint')
####changed ===========
